...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_avalon_adv_adc.v"    -work adc_0            -cdslib ./cds_libs/adc_0.cds.lib           
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_adc_0.v"            -work adc_0            -cdslib ./cds_libs/adc_0.cds.lib           
