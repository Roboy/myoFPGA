...
module soc_system_mm_interconnect_0 (
		...
		output wire [15:0] pid_controller_0_avalon_slave_0_address,                          //                            pid_controller_0_avalon_slave_0.address
		...
		output wire        pid_controller_0_avalon_slave_0_chipselect,                       //                                                           .chipselect
	...
	wire  [129:0] adc_0_adc_slave_agent_rf_source_data;                                               // adc_0_adc_slave_agent:rf_source_data -> adc_0_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [129:0] adc_0_adc_slave_agent_rsp_fifo_out_data;                                            // adc_0_adc_slave_agent_rsp_fifo:out_data -> adc_0_adc_slave_agent:rf_sink_data
	...
	wire  [129:0] pid_controller_0_avalon_slave_0_agent_rf_source_data;                               // pid_controller_0_avalon_slave_0_agent:rf_source_data -> pid_controller_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [129:0] pid_controller_0_avalon_slave_0_agent_rsp_fifo_out_data;                            // pid_controller_0_avalon_slave_0_agent_rsp_fifo:out_data -> pid_controller_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [129:0] spi_0_spi_control_port_agent_rf_source_data;                                        // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [129:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                     // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [128:0] adc_0_adc_slave_agent_rp_data;                                                      // adc_0_adc_slave_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] pid_controller_0_avalon_slave_0_agent_rp_data;                                      // pid_controller_0_avalon_slave_0_agent:rp_data -> router_010:sink_data
	...
	wire  [128:0] pio_led_s1_agent_rp_data;                                                           // pio_led_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [128:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_012:sink_data
	...
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> adc_0_adc_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // adc_0_adc_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> adc_0_adc_slave_burst_adapter:sink0_channel
	...
	wire  [128:0] adc_0_adc_slave_burst_adapter_source0_data;                                         // adc_0_adc_slave_burst_adapter:source0_data -> adc_0_adc_slave_agent:cp_data
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pid_controller_0_avalon_slave_0_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pid_controller_0_avalon_slave_0_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pid_controller_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire  [128:0] pid_controller_0_avalon_slave_0_burst_adapter_source0_data;                         // pid_controller_0_avalon_slave_0_burst_adapter:source0_data -> pid_controller_0_avalon_slave_0_agent:cp_data
	...
	wire    [7:0] pid_controller_0_avalon_slave_0_burst_adapter_source0_channel;                      // pid_controller_0_avalon_slave_0_burst_adapter:source0_channel -> pid_controller_0_avalon_slave_0_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> pio_led_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // pio_led_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_led_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> pio_led_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> pio_led_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> spi_0_spi_control_port_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> spi_0_spi_control_port_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // spi_0_spi_control_port_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> spi_0_spi_control_port_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> spi_0_spi_control_port_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> spi_0_spi_control_port_burst_adapter:sink0_endofpacket
	...
	wire  [128:0] spi_0_spi_control_port_burst_adapter_source0_data;                                  // spi_0_spi_control_port_burst_adapter:source0_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire    [7:0] spi_0_spi_control_port_burst_adapter_source0_channel;                               // spi_0_spi_control_port_burst_adapter:source0_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire          pio_led_s1_agent_rdata_fifo_out_valid;                                              // pio_led_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_led_s1_agent_rdata_fifo_out_data;                                               // pio_led_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          pio_led_s1_agent_rdata_fifo_out_ready;                                              // avalon_st_adapter_006:in_0_ready -> pio_led_s1_agent_rdata_fifo:out_ready
	...
	wire          spi_0_spi_control_port_agent_rdata_fifo_out_valid;                                  // spi_0_spi_control_port_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] spi_0_spi_control_port_agent_rdata_fifo_out_data;                                   // spi_0_spi_control_port_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          spi_0_spi_control_port_agent_rdata_fifo_out_ready;                                  // avalon_st_adapter_007:in_0_ready -> spi_0_spi_control_port_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.av_chipselect          (pid_controller_0_avalon_slave_0_chipselect),             //                         .chipselect
		.av_read                (),                                                       //              (terminated)
		.av_begintransfer       (),                                                       //              (terminated)
		.av_beginbursttransfer  (),                                                       //              (terminated)
		.av_burstcount          (),                                                       //              (terminated)
