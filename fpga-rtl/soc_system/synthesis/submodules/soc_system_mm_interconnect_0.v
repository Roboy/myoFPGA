...
module soc_system_mm_interconnect_0 (
	...
	wire          spi_0_spi_control_port_agent_rp_valid;                                              // spi_0_spi_control_port_agent:rp_valid -> router_010:sink_valid
	wire  [128:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_010:sink_data
	wire          spi_0_spi_control_port_agent_rp_ready;                                              // router_010:sink_ready -> spi_0_spi_control_port_agent:rp_ready
	wire          spi_0_spi_control_port_agent_rp_startofpacket;                                      // spi_0_spi_control_port_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          spi_0_spi_control_port_agent_rp_endofpacket;                                        // spi_0_spi_control_port_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_led_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> spi_0_spi_control_port_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> spi_0_spi_control_port_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // spi_0_spi_control_port_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> spi_0_spi_control_port_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> spi_0_spi_control_port_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> spi_0_spi_control_port_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] spi_0_spi_control_port_burst_adapter_source0_channel;                               // spi_0_spi_control_port_burst_adapter:source0_channel -> spi_0_spi_control_port_agent:cp_channel
