...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communication-msg:<MotorCommand> is deprecated: use communication-msg:MotorCommand instead.")))
...
(cl:defmethod setPoints-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication-msg:setPoints-val is deprecated.  Use communication-msg:setPoints instead.")
  (setPoints m))
