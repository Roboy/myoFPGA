...
if("TRUE" STREQUAL "TRUE")
  set(communication_SOURCE_PREFIX /home/roboy/workspace/myoFPGA/myoFPGA/src/communication)
  set(communication_DEVEL_PREFIX /home/roboy/workspace/myoFPGA/myoFPGA/devel)
  ...
  set(communication_INSTALL_PREFIX /home/roboy/workspace/myoFPGA/myoFPGA/install)
...
if(NOT "/home/roboy/workspace/myoFPGA/myoFPGA/devel/include " STREQUAL " ")
  set(communication_INCLUDE_DIRS "")
  set(_include_dirs "/home/roboy/workspace/myoFPGA/myoFPGA/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simon Trendel <simon.trendel@tum.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboy/workspace/myoFPGA/myoFPGA/src/communication/${idir}'.  Ask the maintainer 'Simon Trendel <simon.trendel@tum.de>' to fix it.")
    endif()
