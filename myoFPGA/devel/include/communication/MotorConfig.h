// Generated by gencpp from file communication/MotorConfig.msg
// DO NOT EDIT!


#ifndef COMMUNICATION_MESSAGE_MOTORCONFIG_H
#define COMMUNICATION_MESSAGE_MOTORCONFIG_H
...
struct MotorConfig_
{
  ...
  typedef boost::shared_ptr< ::communication::MotorConfig_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::communication::MotorConfig_<ContainerAllocator> const> ConstPtr;

}; // struct MotorConfig_

typedef ::communication::MotorConfig_<std::allocator<void> > MotorConfig;

typedef boost::shared_ptr< ::communication::MotorConfig > MotorConfigPtr;
typedef boost::shared_ptr< ::communication::MotorConfig const> MotorConfigConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::communication::MotorConfig_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::communication::MotorConfig_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::communication::MotorConfig_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::communication::MotorConfig_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::communication::MotorConfig_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::communication::MotorConfig_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::communication::MotorConfig_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::communication::MotorConfig_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::communication::MotorConfig_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::communication::MotorConfig_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::communication::MotorConfig_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8[] motors\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::communication::MotorConfig_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::communication::MotorConfig_<ContainerAllocator> >
{
...
#endif // COMMUNICATION_MESSAGE_MOTORCONFIG_H
