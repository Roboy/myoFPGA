...
"""autogenerated by genpy from communication/MotorStatus.msg. Do not edit."""
import sys
...
class MotorStatus(genpy.Message):
  _md5sum = "8e3cb2e63688fce1513f561de7a5ce50"
  _type = "communication/MotorStatus"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int32[] pwmRef
int32[] position
int16[] velocity
int16[] displacement
int16[] current"""
  __slots__ = ['pwmRef','position','velocity','displacement','current']
  _slot_types = ['int32[]','int32[]','int16[]','int16[]','int16[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pwmRef,position,velocity,displacement,current
